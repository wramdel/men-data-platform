"""
Módulo Área Transversal: hub con secciones internas (Dashboard, Consultas, Actividades, Reportes, Indicadores).
"""
...
MODULE_ID = "transversal"
MODULE_TITLE = "Área Transversal"
